...
let scheduleIcon = (config) =>
  <Icon name="calendar" size=36 color=config##tintColor style=Style.(style([marginTop(Pt(5.))])) />;

let locationIcon = (config) =>
  <Icon name="location" size=36 color=config##tintColor style=Style.(style([marginTop(Pt(5.))])) />;

let infoIcon = (config) =>
  <Icon name="question" size=36 color=config##tintColor style=Style.(style([marginTop(Pt(5.))])) />;

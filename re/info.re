    ...
    <ScrollView style=styles##container>
      <View style=styles##contentContainer>
        ...
        <SponsorCard
          ...
          logo=(`Required(Packager.require("../../../static/sponsors/microsoft.png")))
        ...
        <SponsorCard
          ...
          logo=(`Required(Packager.require("../../../static/sponsors/alexaLogo.png")))
        ...
        <SponsorCard
          ...
          logo=(`Required(Packager.require("../../../static/sponsors/imdb.png")))
        ...
        <SponsorCard
          ...
          logo=(`Required(Packager.require("../../../static/sponsors/zillow.png")))
        />
        <SponsorCard
          url="https://www.galvanize.com/seattle/web-development"
          logo=(`Required(Packager.require("../../../static/sponsors/galvanize.png")))
        />
        <SponsorCard
          url="https://www.appsheet.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/appsheet.png")))
        />
        <SponsorCard
          url="https://www.godaddy.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/godaddy.png")))
        />
        <SponsorTitle value="COMMUNITY SPONSORS" />
        <SponsorCard
          url="https://www.npmjs.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/npm-logo.png")))
        />
        <SponsorCard
          url="https://www.sitepen.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/sitepen.png")))
        />
        <SponsorCard
          url="https://www.indeed.jobs/"
          logo=(`Required(Packager.require("../../../static/sponsors/Indeed.png")))
        />
        <SponsorCard
          url="https://www.opendoor.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/Opendoor.png")))
        />
        <SponsorCard
          url="http://shecodesnow.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/she-codes-now.png")))
        />
        <SponsorCard
          url="https://sendgrid.com/"
          logo=(`Required(Packager.require("../../../static/sponsors/sendgrid.png")))
        />
      </View>
    </ScrollView>
};
